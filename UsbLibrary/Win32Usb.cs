...
namespace UsbLibrary
{
    ...
    public class Win32Usb
    {
        ...
        internal struct DeviceInterfaceDataDetail
        {
            internal Int32 Size;
        ...
        [DllImport("hid.dll", SetLastError = true)] internal static extern void HidD_GetHidGuid(ref Guid gHid);
		/// <summary>
        ...
        [DllImport("setupapi.dll", SetLastError = true)] internal static extern IntPtr SetupDiGetClassDevs(ref Guid gClass, IntPtr strEnumerator, IntPtr hParent, uint nFlags);
		/// <summary>
